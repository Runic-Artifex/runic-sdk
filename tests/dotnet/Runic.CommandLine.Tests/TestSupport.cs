...
internal sealed class CapturingSink : ICommandOutcomeSink
{
    ...
    public IReadOnlyList<CommandDiagnostic> Diagnostics { get; private set; } = Array.Empty<CommandDiagnostic>();

    public string? HumanOutput { get; private set; }
        ...
        CancellationToken cancellationToken)
    {
        ...
        HumanOutput = outcome.HumanOutput;
        return ValueTask.CompletedTask;
    }
}
