...
internal static class Program
{
    public static async Task<int> Main()
    {
        ...
        [
            ("window Bridge owns nested references, presentation leases, and detached operation observation", WindowBridgeFirstSliceTests.RunAsync),
            ("window Bridge checked title owner shares typed model receipts across routes", WindowBridgeCheckedTitleFieldTests.RunAsync),
