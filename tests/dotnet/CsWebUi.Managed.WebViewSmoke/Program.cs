...
if (window.ExecuteJavaScript("return document.title;", TimeSpan.FromSeconds(10)) != "CS-WebUI M4 smoke")
{
...
Console.WriteLine("Managed embedded WebView smoke passed.");
