...
// Kept with the private generated adapter because that adapter owns the
// checked-field route shape too. The native replacement browser journey only
// exercises ordinary Title read/write.
...
{
    internal static FixtureTitleReceipt Applied(string id, FixtureTitleSnapshot current) => new(id, FixtureTitleWriteKind.Applied, current, null);
    internal static FixtureTitleReceipt Conflict(string id, FixtureTitleSnapshot current) => new(id, FixtureTitleWriteKind.Conflict, current, null);
    internal static FixtureTitleReceipt Rejected(string id, FixtureTitleSnapshot current, string error) => new(id, FixtureTitleWriteKind.Rejected, current, error);
    internal static FixtureTitleReceipt Expired(string id, FixtureTitleSnapshot current) => new(id, FixtureTitleWriteKind.Expired, current, null);
    internal static FixtureTitleReceipt CommittedWithError(string id, FixtureTitleSnapshot current, string error) => new(id, FixtureTitleWriteKind.CommittedWithError, current, error);
}
