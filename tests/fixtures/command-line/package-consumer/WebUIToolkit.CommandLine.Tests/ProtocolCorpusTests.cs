...
internal static class ProtocolCorpusTests
{
    ...
    private static ValueTask Manifest()
    {
        ...
        AssertEx.Equal("WebUIToolkit.CommandLine", manifest.ImplementationNamespace);
