...
This Linux acceptance runs the packaged editor and the production WebSocket
bridge with the project-pinned Chromium; it does not mock the frontend,
...
the page, bridge frames, and a screenshot for diagnosis.
