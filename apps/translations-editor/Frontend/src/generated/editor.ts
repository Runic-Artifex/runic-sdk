...
export interface EditorView {
  ...
  dispose(): void;
  execute(argument: string): Promise<EditorState>;
}
...
type WireState = EditorState;
function hydrate(wire: WireState): EditorState { return wire; }
...
async function connectEditorAt(route: string, needsMount = false): Promise<EditorView> {
  ...
  return {
    ...
    async execute(argument) {
      return invoke(`${route}Execute`, JSON.stringify(argument));
    },
  };
}
