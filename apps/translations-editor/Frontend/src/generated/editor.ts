// <auto-generated />
import { pageEditorWorkspace, type EditorWorkspacePageReference } from "./editorWorkspace.js";
import { pageEditorDocumentTools, type EditorDocumentToolsPageReference } from "./editorDocumentTools.js";
import { pageEditorReview, type EditorReviewPageReference } from "./editorReview.js";
import { pageEditorInterchange, type EditorInterchangePageReference } from "./editorInterchange.js";
import { pageEditorDiagnostics, type EditorDiagnosticsPageReference } from "./editorDiagnostics.js";
import { pageEditorLocalState, type EditorLocalStatePageReference } from "./editorLocalState.js";
...
export interface EditorState {
  ...
  readonly documentTools: EditorDocumentToolsPageReference;
  readonly review: EditorReviewPageReference;
  readonly interchange: EditorInterchangePageReference;
  readonly diagnostics: EditorDiagnosticsPageReference;
  readonly localState: EditorLocalStatePageReference;
  readonly project: EditorProjectPageReference;
  readonly documents: readonly (EditorDocumentPageReference)[];
}
...
type WireState = Omit<EditorState, "workspace" | "documentTools" | "review" | "interchange" | "diagnostics" | "localState" | "project" | "documents"> & {
  ...
  readonly review: { readonly kind: "editorReview"; readonly id: string };
  readonly interchange: { readonly kind: "editorInterchange"; readonly id: string };
  readonly diagnostics: { readonly kind: "editorDiagnostics"; readonly id: string };
  readonly localState: { readonly kind: "editorLocalState"; readonly id: string };
  readonly project: { readonly kind: "editorProject"; readonly id: string };
  readonly documents: readonly ({ readonly kind: "editorDocument"; readonly id: string })[];
};
function hydrate(wire: WireState): EditorState {
  return {
    ...wire,
    workspace: wire.workspace.kind === "editorWorkspace" ? pageEditorWorkspace(wire.workspace.id) : (() => { throw new BridgeError("failed", "Unknown workspace kind."); })(),
    documentTools: wire.documentTools.kind === "editorDocumentTools" ? pageEditorDocumentTools(wire.documentTools.id) : (() => { throw new BridgeError("failed", "Unknown documentTools kind."); })(),
    review: wire.review.kind === "editorReview" ? pageEditorReview(wire.review.id) : (() => { throw new BridgeError("failed", "Unknown review kind."); })(),
    interchange: wire.interchange.kind === "editorInterchange" ? pageEditorInterchange(wire.interchange.id) : (() => { throw new BridgeError("failed", "Unknown interchange kind."); })(),
    diagnostics: wire.diagnostics.kind === "editorDiagnostics" ? pageEditorDiagnostics(wire.diagnostics.id) : (() => { throw new BridgeError("failed", "Unknown diagnostics kind."); })(),
    localState: wire.localState.kind === "editorLocalState" ? pageEditorLocalState(wire.localState.id) : (() => { throw new BridgeError("failed", "Unknown localState kind."); })(),
    project: wire.project.kind === "editorProject" ? pageEditorProject(wire.project.id) : (() => { throw new BridgeError("failed", "Unknown project kind."); })(),
