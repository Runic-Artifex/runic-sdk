...
profile, grammar 5, runtime ABI 2, caller fingerprint, source hash, typed AST,
and linked markup contract. V4 RMF2 dynamic loading remains on the manifest-v2
path when the selector is omitted.
