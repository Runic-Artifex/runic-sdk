...
| External compiler diagnostics  | `runic.application.frontend-compiler.diagnostics/1.0`        | Frontend SDK integration seam      |
| External compiler hot reload   | `runic.application.frontend-compiler.hot-reload/1.0`         | Frontend SDK integration seam      |
| Rendered fragment inspection   | `runic.application.frontend-compiler.rendered-fragments/1.0` | Developer CLI                      |
...
| Developer CLI diagnostics      | `RAPPDEV1000`–`RAPPDEV1999`                                | `dotnet-runic`                     |
