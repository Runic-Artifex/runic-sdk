...
export const products: Product[] = [
  {
    ...
    summary: "A NativeAOT-first toolbelt for lifecycle, hosting, desktop contracts, MVVM, frontend builds, and developer tooling.",
    description: "Runic Toolkit composes the same application model across desktop windows, browser frontends, Generic Host, and framework-specific UI adapters. It owns the application shell—not every domain capability used by that shell.",
    version: "0.1.0-preview.4.1", source: "https://github.com/Runic-Artifex/runic-toolkit",
    bestFor: ["Composing .NET desktop and browser applications", "NativeAOT-safe MVVM transport and bindings", "Sharing frontend-neutral lifecycle and hosting contracts"],
    boundaries: ["Does not own markup, flow, command-line parsing, localization, or assets", "Accepts integrations through stable Desktop, Hosting, MVVM, and Frontend contracts", "NuGet and npm packages release from the same source version"],
    packages: ["RunicToolkit.Collections", "RunicToolkit.Desktop", "RunicToolkit.Frontend.Sdk", "RunicToolkit.Hosting.Abstractions", "RunicToolkit.Hosting.Build", "RunicToolkit.Hosting.CsWebUi", "RunicToolkit.Hosting.CsWebUi.App", "RunicToolkit.Hosting.CsWebUi.Mvvm", "RunicToolkit.Hosting.Generators", "RunicToolkit.Hosting.GenericHost", "RunicToolkit.Hosting.WebUi", "RunicToolkit.Hosting", "RunicToolkit.MVVM.Build", "RunicToolkit.MVVM.CommunityToolkit", "RunicToolkit.MVVM.ReactiveUI", "RunicToolkit.MVVM", "RunicToolkit.MVVM.BindingCompiler", "RunicToolkit.DotNet.RunicToolkit"],
    npmPackages: ["@runic-artifex/mvvm", "@runic-artifex/mvvm-conformance", "@runic-artifex/mvvm-angular", "@runic-artifex/mvvm-react", "@runic-artifex/mvvm-svelte", "@runic-artifex/mvvm-vue"],
    install: ["dotnet add package RunicToolkit.Hosting.CsWebUi.App --version 0.1.0-preview.4.1", "npm install @runic-artifex/mvvm@0.1.0-preview.4.1"],
  },
  {
  ...
  {
    slug: "runic-markup", name: "Runic Markup", shortName: "Markup", mark: "RM",
    kicker: "Language platform",
    summary: "Compiled .cwhtml and .cwuix languages with a deterministic compiler, MSBuild integration, tools, LSP, and VS Code support.",
    description: "Runic Markup is a UI-language platform whose core does not depend on ASP.NET Core, Runic Toolkit, or another UI framework. Product-owned adapters add host and MVVM semantics above the language core.",
    version: "0.1.0-preview.9.1", source: "https://github.com/Runic-Artifex/runic-markup",
    bestFor: ["Compiled HTML-oriented UI with C# generation", "Editor-backed .NET markup languages", "NativeAOT-safe rendering contracts"],
    boundaries: ["Language core stays UI-framework neutral", "Owns every Runic Toolkit markup integration", "VS Code extension is built with the matching release candidate"],
    packages: ["RunicMarkup", "RunicMarkup.Compiler", "RunicMarkup.Build", "RunicMarkup.Tool", "RunicMarkup.LanguageServer", "RunicMarkup.RunicToolkit.Htmx", "RunicMarkup.RunicToolkit.Htmx.Js", "RunicMarkup.RunicToolkit.Htmx.CsWebUi", "RunicMarkup.RunicToolkit.Htmx.CsWebUi.App", "RunicMarkup.RunicToolkit.CommunityToolkit", "RunicMarkup.RunicToolkit.FrontendCompiler"],
    install: ["dotnet add package RunicMarkup.Build --version 0.1.0-preview.9.1"],
  },
  {
