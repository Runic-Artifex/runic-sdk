...
export const products: Product[] = [
  {
    ...
    version: "0.1.0-preview.13.1", source: "https://github.com/Runic-Artifex/runic-toolkit",
    bestFor: ["Composing .NET desktop and browser applications", "NativeAOT-safe application hosting", "Effect Schema-first application contracts with generated C# dispatch"],
    boundaries: ["Does not own UI languages, flow, command-line parsing, localization, or assets", "Uses named domain commands and events rather than exposing ViewModels as the public application contract", "Rendering frameworks own presentation state; the bridge owns validation, transport, sessions, revisions, and operations"],
    packages: ["RunicToolkit.ApplicationBridge", "RunicToolkit.ApplicationBridge.Generators", "RunicToolkit.Collections", "RunicToolkit.Desktop", "RunicToolkit.Hosting.Abstractions", "RunicToolkit.Hosting.Build", "RunicToolkit.Hosting.CsWebUi", "RunicToolkit.Hosting.CsWebUi.App", "RunicToolkit.Hosting.CsWebUi.ApplicationBridge", "RunicToolkit.Hosting.Generators", "RunicToolkit.Hosting.GenericHost", "RunicToolkit.Hosting.WebUi", "RunicToolkit.Hosting", "RunicToolkit.DotNet.RunicToolkit", "RunicToolkit.Templates"],
    npmPackages: ["@runic-artifex/application-bridge"],
    install: ["dotnet add package RunicToolkit.Hosting.CsWebUi.ApplicationBridge --version 0.1.0-preview.13.1", "npm install @runic-artifex/application-bridge@0.1.0-preview.13.1 effect@3.22.1"],
  },
  {
