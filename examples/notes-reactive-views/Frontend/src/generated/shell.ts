...
export interface ShellState {
  ...
  readonly main: HomePageReference | DocumentPageReference;
...
type WireState = Omit<ShellState, "main"> & {
  readonly main: { readonly kind: "home"; readonly id: string } | { readonly kind: "document"; readonly id: string };
};
function hydrate(wire: WireState): ShellState {
  return {
    ...wire,
    main: wire.main.kind === "home" ? pageHome(wire.main.id) : wire.main.kind === "document" ? pageDocument(wire.main.id) : (() => { throw new BridgeError("failed", "Unknown main kind."); })(),
  };
}
...
const bridgeContract = "NotesReactiveViews.ShellViewModel:B32F54EB46E3F31E65C51A00A2C7395E4451D3C9F8F5BEC6510E94BB9FE7522B";
