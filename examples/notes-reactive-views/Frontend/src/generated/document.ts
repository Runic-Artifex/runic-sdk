...
export interface DocumentView {
  ...
  startShowEditor(): Promise<DocumentShowEditorOperation>;
  startShowEditorWithRequestId(requestId: string): Promise<DocumentShowEditorOperation>;
  recoverShowEditorWithRequestId(requestId: string): Promise<DocumentShowEditorOperation>;
  startShowPreview(): Promise<DocumentShowPreviewOperation>;
...
type WireState = Omit<DocumentState, "currentPane" | "compactNote"> & {
  ...
  readonly compactNote: { readonly kind: "editorCompact"; readonly id: string };
};
...
const bridgeContract = "NotesReactiveViews.DocumentViewModel:B32F54EB46E3F31E65C51A00A2C7395E4451D3C9F8F5BEC6510E94BB9FE7522B";
