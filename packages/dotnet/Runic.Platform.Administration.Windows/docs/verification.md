...
This local package is not adopted by Setup, ClientInstaller or ServiceTool.
No release, commit, push or publication is part of this work. Local packing and
package-only consumer checks are delivery checks, not approval for deployment.
