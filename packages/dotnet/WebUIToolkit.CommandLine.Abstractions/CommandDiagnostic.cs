...
public sealed record CommandDiagnostic
{
    ...
    /// <param name="code">A reserved <c>WUTCLI####</c> diagnostic identifier.</param>
    ...
    /// <summary>Gets the reserved <c>WUTCLI####</c> identifier.</summary>
    ...
    private static void ValidateCode(string code)
    {
        ...
        if (code is null ||
            ...
            !code.StartsWith("WUTCLI", StringComparison.Ordinal))
        {
            throw new ArgumentException(
                "Diagnostic codes must be reserved WUTCLI0001 through WUTCLI9999 identifiers.",
                nameof(code));
        }
