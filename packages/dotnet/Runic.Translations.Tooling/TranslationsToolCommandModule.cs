...
public static class TranslationsToolCommandModule
{
    ...
    [Command("init", Description = "Create an RMF2 translation project and starter resources.")][CommandResult("runic.translations.tool/1", typeof(TranslationsToolCommandJsonContext))]
