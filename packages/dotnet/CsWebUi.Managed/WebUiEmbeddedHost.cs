...
/// <summary>Creates an embedded platform WebView host for a managed WebUI window.</summary>
...
/// <summary>Hosts one managed WebUI page in a platform-native embedded WebView window.</summary>
