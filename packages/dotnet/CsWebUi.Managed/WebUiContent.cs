...
/// <summary>Handles one URL-decoded path before managed WebUI falls back to its local root.</summary>
...
/// <summary>Represents a complete virtual response returned by a managed WebUI file handler.</summary>
public sealed class WebUiContent
{
    ...
    /// <summary>Gets optional response headers applied after managed WebUI's compatibility headers.</summary>
