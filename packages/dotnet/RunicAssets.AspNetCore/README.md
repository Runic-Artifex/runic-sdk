...
```bash
dotnet add package RunicAssets.AspNetCore --prerelease
```

The package targets **.NET 10**, uses the shared `Microsoft.AspNetCore.App`
framework, and brings `RunicAssets` with it. It is currently a preview package.
