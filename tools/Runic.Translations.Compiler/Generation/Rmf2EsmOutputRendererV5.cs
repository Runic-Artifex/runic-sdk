...
internal static class Rmf2EsmOutputRendererV5
{
    ...
    private static string Runtime(Rmf2ProjectV5 project)
    {
        ...
        writer.Line("export const esmAbiVersion = " + TranslationOutputRenderer.Rmf2V5EsmAbiVersion + ";");
    ...
    private static TranslationGeneratedOutput Manifest(Rmf2ProjectV5 project, List<TranslationGeneratedOutput> outputs, string root)
    {
        ...
        var json = new StringBuilder("{\"webModuleManifestVersion\":" + TranslationOutputRenderer.WebModuleManifestV3Version + ",\"esmAbiVersion\":" + TranslationOutputRenderer.Rmf2V5EsmAbiVersion + ",\"rmf2RuntimeAbiVersion\":2,\"messageGrammarVersion\":5,\"profile\":\"rmf2-execution-v2\",\"generatedNameVersion\":1,\"catalog\":")
