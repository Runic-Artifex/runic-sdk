...
internal static class Rmf2CSharpOutputRendererV5
{
    ...
    private static GenerationWriter StartFile(Rmf2ProjectV5 project) { var writer = new GenerationWriter(); writer.Line("// <auto-generated />"); writer.Line("#nullable enable"); writer.Line("#pragma warning disable CS1591"); writer.Blank(); writer.Line("namespace " + GenerationSupport.CSharpNamespace(project.CodeNamespace) + ";"); writer.Blank(); return writer; }
